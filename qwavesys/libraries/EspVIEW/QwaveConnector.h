...
public:
    ...
    String httpPUT(const int httpPort, String HOST, String URI);
    String httpsPUT(String HOST, String URI);
    String httpPOST(const int httpPort, String HOST, String URI, String DATA);
    String lineNotify(const int httpPort, String Authorization, String HOST, String URI, String DATA);
    String httpsPOST(String HOST, String URI, String DATA);
    
    void httpUpload_Open(const int httpPort, String HOST, String URI, String name, String filename, uint32_t data_len);
