...
- Enter ```https://github.com/QWaveSystems/Mego-Arduino/releases/download/2.5.0/package_mego_index.json``` into *Additional Board Manager URLs* field. You can add multiple URLs, separating them with commas.
